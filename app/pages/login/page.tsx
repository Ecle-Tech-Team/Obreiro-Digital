        ...
        <div className="flex justify-center items-center">
          <div>
            <div className="flex justify-center">
              ...
              <h2 className="ml-3 font-extrabold text-4xl text-white text1">
                OBREIRO
                <br />
                DIGITAL
              </h2>
            ...
            <div className="flex flex-col">
              <div>
                <h1 className="text-white text-4xl mt-10 text1 flex justify-center">
                  Login
                </h1>
                <p className="text-white text-xl text2 mt-2 flex justify-center mb-6">
                  Bem-vindo(a) de volta!
                </p>
              </div>

              <div className="flex flex-col">
                <label className="text-white text1 text-xl mt-2 mb-1">
                  Email
                </label>
              ...
              <button
                type="submit"
                className="border-2 rounded-lg h-12 mt-3 border-white text2 text-white active:bg-white active:text-azul"
                onClick={handleLogin}
              >
                Entrar
              </button>
              ...
              <div className="flex justify-center mt-6">
                <p className="text-lg text2 text-white">
                  Novo por aqui?
                  <Link
                    href={"/../../pages/cadastroIgreja"}
                    className="text1 ml-1"
                  >
                    Cadastro
                  </Link>
                </p>
